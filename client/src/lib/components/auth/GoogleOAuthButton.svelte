...
<script lang="ts">
	...
	import { initiateGoogleOAuth } from '$lib/services/apiAuth';
...
<!--
	...
	<GoogleOAuthButton />
	<GoogleOAuthButton variant="default" size="lg" />
	<GoogleOAuthButton disabled={loading} class="mt-4" />
-->
